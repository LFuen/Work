...
class About extends Component{
    render(){
        ...
        <AboutDiv className='about'>
            ...
            <p className='item'>I have been a software engineer for almost 4 years. I greatly enjoy designing and crafting out specifics in user experience. Front End development and design is where I prefer to spend my time and it's what I do best.</p>
